...
hes_records <- filter(hes_records, !(eid %in% withdraw[,1]))
hes_records <- hes_records[!duplicated(hes_records),]
gp_records <- filter(gp_records, !(eid %in% withdraw[,1]))
gp_records <- gp_records[!duplicated(gp_records),]
cr_records <- filter(cr_records, !(eid %in% withdraw[,1]))
cr_records <- cr_records[!duplicated(cr_records),]
death_records <- filter(death_records, !(eid %in% withdraw[,1]))

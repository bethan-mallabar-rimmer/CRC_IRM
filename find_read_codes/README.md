...
Source for all columns except 'old_readcode': publicly available at https://biobank.ndph.ox.ac.uk/showcase/refer.cgi?id=592 (primarycare_codings.zip, read_ctv3_lkp tab in the Excel table.)</p>
